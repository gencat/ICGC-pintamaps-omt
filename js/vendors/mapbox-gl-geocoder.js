...
({
	...
	2 : [function (e, t, n) {
			...
			function f(e, t) {
				if (d.isNullOrUndefined(e) || d.isNullOrUndefined(t))
					return !1;
				if (e.prototype !== t.prototype)
					return !1;
				if (d.isPrimitive(e) || d.isPrimitive(t))
					return e === t;
				var n = a(e),
				r = a(t);
				if (n && !r || !n && r)
					return !1;
				if (n)
					return e = h.call(e), t = h.call(t), c(e, t);
				var i,
				o,
				u = v(e),
				s = v(t);
				if (u.length != s.length)
					return !1;
				for (u.sort(), s.sort(), o = u.length - 1; o >= 0; o--)
					if (u[o] != s[o])
						return !1;
			...
			function p(e, t, n, r) {
				...
				if (r = (n && n.name ? " (" + n.name + ")." : ".") + (r ? " " + r : "."), e && !i && u(i, n, "Missing expected exception" + r), !e && l(i, n) && u(i, n, "Got unwanted exception" + r), e && i && n && !l(i, n) || !e && i)
					throw i
			}
			var d = e("util/"),
			...
			y.AssertionError = function (e) {
				...
				e.message ? (this.message = e.message, this.generatedMessage = !1) : (this.message = o(this), this.generatedMessage = !0);
			...
			d.inherits(y.AssertionError, Error),
			y.fail = u,
			y.ok = s,
			...
			y.notEqual = function (e, t, n) {
				e == t && u(e, t, n, "!=", y.notEqual)
			},
			y.deepEqual = function (e, t, n) {
				c(e, t) || u(e, t, n, "deepEqual", y.deepEqual)
			},
			y.notDeepEqual = function (e, t, n) {
				c(e, t) && u(e, t, n, "notDeepEqual", y.notDeepEqual)
			},
			y.strictEqual = function (e, t, n) {
				e !== t && u(e, t, n, "===", y.strictEqual)
			},
			y.notStrictEqual = function (e, t, n) {
				e === t && u(e, t, n, "!==", y.notStrictEqual)
			},
	...
	3 : [function (e, t, n) {
			...
			r.prototype.emit = function (e) {
				...
				if (i(n))
					...
					for (r = arguments.length, o = new Array(r - 1), c = 1; r > c; c++)
						o[c - 1] = arguments[c];
					for (a = n.slice(), r = a.length, c = 0; r > c; c++)
						a[c].apply(this, o)
				}
				return !0
			},
			r.prototype.addListener = function (e, t) {
				...
				if (this._events || (this._events = {}), this._events.newListener && this.emit("newListener", e, i(t.listener) ? t.listener : t), this._events[e] ? u(this._events[e]) ? this._events[e].push(t) : this._events[e] = [this._events[e], t] : this._events[e] = t, u(this._events[e]) && !this._events[e].warned) {
					var n;
					n = s(this._maxListeners) ? r.defaultMaxListeners : this._maxListeners,
					n && n > 0 && this._events[e].length > n && (this._events[e].warned = !0, console.error("(node) warning: possible EventEmitter memory leak detected. %d listeners added. Use emitter.setMaxListeners() to increase limit.", this._events[e].length), "function" == typeof console.trace && console.trace())
				}
				return this
			},
	...
	7 : [function (e, t, n) {
			(function (t, r) {
				...
				function c(e, t, r) {
					...
					var u = Object.keys(t),
					m = s(u);
					if (e.showHidden && (u = Object.getOwnPropertyNames(t)), T(t) && (u.indexOf("message") >= 0 || u.indexOf("description") >= 0))
						return f(t);
					if (0 === u.length) {
						if (O(t)) {
							var y = t.name ? ": " + t.name : "";
					...
					if (_(t) && (v = " " + RegExp.prototype.toString.call(t)), j(t) && (v = " " + Date.prototype.toUTCString.call(t)), T(t) && (v = " " + f(t)), 0 === u.length && (!g || 0 == t.length))
						return b[0] + v + b[1];
					if (0 > r)
						return _(t) ? e.stylize(RegExp.prototype.toString.call(t), "regexp") : e.stylize("[Object]", "special");
					e.seen.push(t);
					var E;
					return E = g ? l(e, t, r, m, u) : u.map(function (n) {
				...
				function l(e, t, n, r, i) {
					for (var o = [], u = 0, s = t.length; s > u; ++u)
						C(t, String(u)) ? o.push(p(e, t, n, r, String(u), !0)) : o.push("");
				...
				function p(e, t, n, r, i, o) {
					...
					if (a = Object.getOwnPropertyDescriptor(t, i) || {
							value : t[i]
						}, a.get ? s = a.set ? e.stylize("[Getter/Setter]", "special") : e.stylize("[Getter]", "special") : a.set && (s = e.stylize("[Setter]", "special")), C(r, i) || (u = "[" + i + "]"), s || (e.seen.indexOf(a.value) < 0 ? (s = y(n) ? c(e, a.value, null) : c(e, a.value, n - 1), s.indexOf("\n") > -1 && (s = o ? s.split("\n").map(function (e) {
											return "  " + e
										}).join("\n").substr(2) : "\n" + s.split("\n").map(function (e) {
											return "   " + e
										}).join("\n"))) : s = e.stylize("[Circular]", "special")), x(u)) {
						if (o && i.match(/^\d+$/))
							return s;
						u = JSON.stringify("" + i),
						u.match(/^"([a-zA-Z_][a-zA-Z_0-9]*)"$/) ? (u = u.substr(1, u.length - 2), u = e.stylize(u, "name")) : (u = u.replace(/'/g, "\\'").replace(/\\"/g, '"').replace(/(^"|"$)/g, "'"), u = e.stylize(u, "string"))
					}
					return u + ": " + s
				}
				function d(e, t, n) {
				...
				n.format = function (e) {
					...
					for (var n = 1, r = arguments, o = r.length, u = String(e).replace(R, function (e) {
								if ("%%" === e)
									return "%";
								if (n >= o)
									return e;
				...
				n.debuglog = function (e) {
					if (x(P) && (P = t.env.NODE_DEBUG || ""), e = e.toUpperCase(), !q[e])
	...
	8 : [function (e, t, n) {
			function r(e, t, n) {
				...
				function o(t, n) {
					n && clearTimeout(n),
					d = v = g = void 0,
					t && (w = a(), h = e.apply(y, p), v || d || (p = y = void 0))
				}
				function c() {
					var e = t - (a() - m);
				...
				function l() {
					if (p = arguments, m = a(), y = this, g = x && (v || !_), b === !1)
						var n = _ && !v;
					else {
						d || _ || (w = m);
						var r = b - (m - w),
						i = 0 >= r || r > b;
						i ? (d && (d = clearTimeout(d)), w = m, h = e.apply(y, p)) : d || (d = setTimeout(f, r))
					}
					return i && v ? v = clearTimeout(v) : v || t === b || (v = setTimeout(c, t)),
					n && (i = !0, h = e.apply(y, p)),
					!i || v || d || (p = y = void 0),
					h
				}
				...
				if (t = 0 > t ? 0 : +t || 0, n === !0) {
					...
					i(n) && (_ = !!n.leading, b = "maxWait" in n && s(+n.maxWait || 0, t), x = "trailing" in n ? !!n.trailing : x);
				return l.cancel = r,
				l
			}
			function i(e) {
	...
	9 : [function (e, t, n) {
			...
			function s(e) {
				return null == e ? !1 : o(e) ? h.test(l.call(e)) : r(e) && a.test(e)
			}
	...
	11 : [function (e, t, n) {
			...
			i = r({
					success : function (e) {
						var t = e && e.request,
						n = t && t.callback;
						return "function" == typeof n && n(null, e.entity),
						e
					},
					error : function (e) {
						var t = e && e.request,
	...
	13 : [function (e, t, n) {
			t.exports.DEFAULT_ENDPOINT = "https://api.mapbox.com",
			t.exports.API_GEOCODER_FORWARD = "/geocoding/v5/{dataset}/{query}.json{?proximity}",
			t.exports.API_GEOCODER_REVERSE = "/geocoding/v5/{dataset}/{longitude},{latitude}.json",
			t.exports.API_DIRECTIONS = "/v4/directions/{profile}/{encodedWaypoints}.json{?alternatives,instructions,geometry,steps}",
			t.exports.API_DISTANCE = "/distances/v1/mapbox/{profile}",
			t.exports.API_SURFACE = "/v4/surface/{mapid}.json{?layer,fields,points,geojson,interpolate,encoded_polyline}",
			t.exports.API_UPLOADS = "/uploads/v1/{owner}",
			t.exports.API_UPLOAD = "/uploads/v1/{owner}/{upload}",
			t.exports.API_UPLOAD_CREDENTIALS = "/uploads/v1/{owner}/credentials",
			t.exports.API_MATCHING = "/matching/v4/{profile}.json",
			t.exports.API_DATASET_DATASETS = "/datasets/v1/{owner}",
			t.exports.API_DATASET_DATASET = "/datasets/v1/{owner}/{dataset}",
			t.exports.API_DATASET_FEATURES = "/datasets/v1/{owner}/{dataset}/features{?reverse,limit,start}",
			t.exports.API_DATASET_FEATURE = "/datasets/v1/{owner}/{dataset}/features/{id}",
			t.exports.API_TILESTATS_STATISTICS = "/tilestats/v1/{owner}/{tileset}",
			t.exports.API_TILESTATS_LAYER = "/tilestats/v1/{owner}/{tileset}/{layer}",
			t.exports.API_TILESTATS_ATTRIBUTE = "/tilestats/v1/{owner}/{tileset}/{layer}/{attribute}",
			t.exports.API_STATIC = "/v4/{mapid}{+overlay}/{+xyz}/{width}x{height}{+retina}{.format}"
		}, {}
	...
	14 : [function (e, t, n) {
			(function (n) {
				...
				function r(e) {
					...
					if (!t)
						return null;
					if (t = t.replace(/-/g, "+").replace(/_/g, "/"), n.browser)
						t = t.replace(/=/g, "");
					else {
						var r = t.length % 4;
						if (2 === r && (t += "=="), 3 === r && (t += "="), 1 === r || r > 3)
							return null
					}
					try {
	...
	15 : [function (e, t, n) {
			...
			function r(e) {
				function t(t, n) {
					this.name = e,
					i("string" == typeof t, "accessToken required to instantiate Mapbox client");
					var r = o.DEFAULT_ENDPOINT;
					void 0 !== n && (i("object" == typeof n, "options must be an object"), n.endpoint && (i("string" == typeof n.endpoint, "endpoint must be a string"), r = n.endpoint), n.account && (i("string" == typeof n.account, "account must be a string"), this.owner = n.account)),
					this.client = u({
							endpoint : r,
							accessToken : t
						}),
					this.accessToken = t,
					this.endpoint = r,
					this.owner = this.owner || s(t),
					i(!!this.owner, "could not determine account from provided accessToken")
				}
				return t
			}
			var i = e("assert"),
	...
	16 : [function (e, t, n) {
			...
			c = 5,
			a = 3;
			s.prototype.geocodeForward = function (e, t, n) {
				void 0 === n && "function" == typeof t && (n = t, t = {}),
				i("string" == typeof e, "query must be a string"),
				i("object" == typeof t, "options must be an object"),
				i("function" == typeof n, "callback must be a function");
				var o = {
					query : e,
					dataset : "mapbox.places"
				},
				s = a;
				t.precision && (i("number" == typeof t.precision, "precision option must be number"), s = t.precision),
				t.proximity && (i("number" == typeof t.proximity.latitude && "number" == typeof t.proximity.longitude, "proximity must be an object with numeric latitude & longitude properties"), o.proximity = r(t.proximity.longitude, s) + "," + r(t.proximity.latitude, s)),
				t.dataset && (i("string" == typeof t.dataset, "dataset option must be string"), o.dataset = t.dataset),
				this.client({
					path : u.API_GEOCODER_FORWARD,
					params : o,
					callback : n
				})
			},
			s.prototype.geocodeReverse = function (e, t, n) {
				void 0 === n && "function" == typeof t && (n = t, t = {}),
				i("object" == typeof e, "location must be an object"),
				i("object" == typeof t, "options must be an object"),
				i("function" == typeof n, "callback must be a function"),
				i("number" == typeof e.latitude && "number" == typeof e.longitude, "location must be an object with numeric latitude & longitude properties");
				var o = "mapbox.places";
				t.dataset && (i("string" == typeof t.dataset, "dataset option must be string"), o = t.dataset);
				var s = c;
				t.precision && (i("number" == typeof t.precision, "precision option must be number"), s = t.precision),
				this.client({
					path : u.API_GEOCODER_REVERSE,
					params : {
						longitude : r(e.longitude, s),
						latitude : r(e.latitude, s),
						dataset : o
					},
					callback : n
				})
			...
			!function (e, t) {
				...
				e(function (e) {
					function r(e, t) {
						...
						if (n = e, i = {}, t) {
							for (r in t)
								o = new RegExp("\\{" + r + "\\}"), o.test(n) ? n = n.replace(o, encodeURIComponent(t[r]), "g") : i[r] = t[r];
							for (r in i)
								n += -1 === n.indexOf("?") ? "?" : "&", n += encodeURIComponent(r), null !== i[r] && void 0 !== i[r] && (n += "=", n += encodeURIComponent(i[r]))
						}
						return n
					}
					function i(e, t) {
					...
					function o(e, t) {
						return this instanceof o ? void(e instanceof o ? (this._template = e.template, this._params = u({}, this._params, t)) : (this._template = (e || "").toString(), this._params = t || {})) : new o(e, t)
					}
					var u,
					s,
					c,
					a,
					f;
					return u = e("./util/mixin"),
					c = /([a-z][a-z0-9\+\-\.]*:)\/\/([^@]+@)?(([^:\/]+)(:([0-9]+))?)?(\/[^?#]*)?(\?[^#]*)?(#\S*)?/i,
					a = /^([a-z][a-z0-9\-\+\.]*:\/\/|\/)/i,
					f = /([a-z][a-z0-9\+\-\.]*:)\/\/([^@]+@)?(([^:\/]+)(:([0-9]+))?)?\//i,
					o.prototype = {
						append : function (e, t) {
							return new o(this._template + e, u({}, this._params, t))
						},
						fullyQualify : function () {
							...
							return i(e, "//") ? e = s.protocol + e : i(e, "/") ? e = s.origin + e : this.isAbsolute() || (e = s.origin + s.pathname.substring(0, s.pathname.lastIndexOf("/") + 1)),
							-1 === e.indexOf("/", 8) && (e += "/"),
							new o(e, this._params)
						},
						isAbsolute : function () {
						...
						isCrossOrigin : function () {
							if (!s)
								return !0;
							var e = this.parts();
							return e.protocol !== s.protocol || e.hostname !== s.hostname || e.port !== s.port
						},
						parts : function () {
							var e,
							t;
							return e = this.fullyQualify().build().match(c),
							t = {
								href : e[0],
								protocol : e[1],
								host : e[3] || "",
							...
							t.port = t.port || ("https:" === t.protocol ? "443" : "http:" === t.protocol ? "80" : ""),
							t
						},
						build : function (e) {
							return r(this._template, u({}, this._params, e))
						},
						toString : function () {
							return this.build()
						}
					},
					s = t ? new o(t.href).parts() : n,
					o
				})
			}
	...
	18 : [function (e, t, n) {
			!function (e) {
				...
				e(function (e) {
					...
					n = e("./client/xhr");
					return t.setPlatformDefaultClient(n),
					t
				})
			}
			("function" == typeof define && define.amd ? define : function (n) {
	...
	21 : [function (e, t, n) {
			!function (e, t) {
				...
				e(function (e) {
					...
					return i = e("when"),
					o = e("../UrlBuilder"),
					u = e("../util/normalizeHeaderName"),
					s = e("../util/responsePromise"),
					c = e("../client"),
					a = /[\r|\n]+/,
					c(function (e) {
						return s.promise(function (i, u) {
							var s,
							c,
							a,
							f,
							...
							if (e = "string" == typeof e ? {
								...
								return d.error = "precanceled", void u(d);
							if (h = e.engine || t.XMLHttpRequest, !h)
								return void u({
									request : e,
							...
							try {
								...
								f = e.headers;
								for (p in f)
									("Content-Type" !== p || "multipart/form-data" !== f[p]) && s.setRequestHeader(p, f[p]);
								e.canceled = !1,
								e.cancel = function () {
									e.canceled = !0,
									s.abort(),
								...
								s.onreadystatechange = function () {
									e.canceled || s.readyState === (h.DONE || 4) && (d.status = {
											code : s.status,
											text : s.statusText
										}, d.headers = n(s.getAllResponseHeaders()), d.entity = s.responseText, d.status.code > 0 ? i(d) : setTimeout(function () {
											i(d)
										}, 0))
								};
								try {
			...
			!function (e) {
				...
				e(function (e) {
					...
					function u(e) {
						...
						u = e.init || t,
						c = e.request || n,
						p = e.success || e.response || r,
						d = e.error || function () {
							return l((e.response || r).apply(this, arguments), l.reject, l.reject)
						},
						function (t, n) {
							function r(e) {
								var u,
								...
								e = "string" == typeof e ? {
								 ...
								 : e || {},
								e.originator = e.originator || r,
								a(c.call(u, e, n, s), function (e) {
									var r,
									c,
									a;
									return a = t,
									e instanceof o && (c = e.abort, a = e.client || a, r = e.response, e = e.request),
									r = r || l(e, function (e) {
											return l(a(e), function (e) {
												return p.call(u, e, n, s)
											}, function (e) {
												return d.call(u, e, n, s)
											})
										}),
									c ? i([r, c]) : r
								}, function (t) {
							...
							"function" != typeof t && (t = e.client || s),
							n = u(n || {}),
							f(r, t)
						}
					}
					...
					f,
					l;
					return s = e("./client/default"),
					c = e("./util/mixin"),
					a = e("./util/responsePromise"),
					f = e("./client"),
					l = e("when"),
					u.ComplexRequest = o,
					u
	...
	25 : [function (e, t, n) {
			!function (e) {
				...
				e(function (e) {
					...
					t({
						init : function (e) {
							return e.registry = e.registry || r,
							e
						},
						request : function (e, t) {
							var r,
							u;
							return u = e.headers || (e.headers = {}),
							r = n.parse(u["Content-Type"] = u["Content-Type"] || t.mime || "text/plain"),
							u.Accept = u.Accept || t.accept || r.raw + ", application/json;q=0.8, text/plain;q=0.5, */*;q=0.2",
							"entity" in e ? t.registry.lookup(r).otherwise(function () {
								if (t.permissive)
									return i;
								throw "mime-unknown"
							}).then(function (n) {
						...
						response : function (e, t) {
							if (!(e.headers && e.headers["Content-Type"] && e.entity))
								return e;
							...
							return t.registry.lookup(r).otherwise(function () {
								...
								return o.attempt(n.read, e.entity, {
									...
									throw e.error = "mime-deserialization",
									e.cause = t,
									e
								}).then(function (t) {
									return e.entity = t,
	...
	26 : [function (e, t, n) {
			!function (e) {
				...
				e(function (e) {
					...
					var r,
					i;
					return r = e("../interceptor"),
					i = e("../UrlBuilder"),
					r({
						request : function (e, r) {
							var o;
							return r.prefix && !new i(e.path).isFullyQualified() && (o = r.prefix, e.path && (n(o, "/") || t(e.path, "/") || (o += "/"), o += e.path), e.path = o),
							e
						}
					})
				})
				...
				e(function (e) {
					...
					t({
						...
						request : function (e, t) {
							var i,
							o;
							return i = e.path || t.template,
							o = r({}, e.params, t.params),
							e.path = n.expand(i, o),
							delete e.params,
							e
						}
				...
				e(function (e) {
					function t(e) {
						this.lookup = function (t) {
							var i;
							return i = "string" == typeof t ? n.parse(t) : t,
							e[i.raw] ? e[i.raw] : e[i.type + i.suffix] ? e[i.type + i.suffix] : e[i.type] ? e[i.type] : e[i.suffix] ? e[i.suffix] : r.reject(new Error('Unable to locate converter for mime "' + i.raw + '"'));
						},
					...
					r = e("when"),
					i = new t({}),
					i.register("application/hal", e("./type/application/hal")),
					i.register("application/json", e("./type/application/json")),
					i.register("application/x-www-form-urlencoded", e("./type/application/x-www-form-urlencoded")),
					i.register("multipart/form-data", e("./type/multipart/form-data")),
					i.register("text/plain", e("./type/text/plain")),
					i.register("+json", i.delegate("application/json")),
					i
				})
			}
			("function" == typeof define && define.amd ? define : function (n) {
	...
	30 : [function (e, t, n) {
			!function (e) {
				...
				e(function (e) {
					...
					u,
					s;
					return n = e("../../../interceptor/pathPrefix"),
					r = e("../../../interceptor/template"),
					i = e("../../../util/find"),
					o = e("../../../util/lazyPromise"),
					u = e("../../../util/responsePromise"),
					s = e("when"), {
						read : function (e, c) {
							function a(e, t) {
								(t && l && l.warn || l.log) && (l.warn || l.log).call(l, "Relationship '" + e + "' is deprecated, see " + t)
							}
							var f,
							l;
							return c = c || {},
							f = c.client,
							l = c.console || l,
							c.registry.lookup(c.mime.suffix).then(function (l) {
								return s(l.read(e, c)).then(function (e) {
									...
									i.findProperties(e, "_links", function (e, i, s) {
										Object.keys(e).forEach(function (n) {
											var s = e[n];
											n in i || t(i, n, u.make(o(function () {
														return s.deprecation && a(n, s.deprecation),
														s.templated === !0 ? r(f)({
															path : s.href
														}) : f({
															path : s.href
										...
										t(i, s, e),
										t(i, "clientFor", function (t, i) {
											var o = e[t];
											if (!o)
												throw new Error("Unknown relationship: " + t);
											return o.deprecation && a(t, o.deprecation),
											o.templated === !0 ? r(i || f, {
												template : o.href
											}) : n(i || f, {
												prefix : o.href
				...
				e(function () {
					...
					function n(t, r, i) {
						return Array.isArray(i) ? i.forEach(function (e) {
							t = n(t, r, e)
						}) : (t.length > 0 && (t += "&"), t += e(r), void 0 !== i && null !== i && (t += "=" + e(i))),
						t
					}
					var r,
					i;
					...
					i = /\+/g, {
						read : function (e) {
							...
							return e.split("&").forEach(function (e) {
								...
								r = e.split("="),
								i = t(r[0]),
								o = 2 === r.length ? t(r[1]) : null,
								i in n ? (Array.isArray(n[i]) || (n[i] = [n[i]]), n[i].push(o)) : n[i] = o
							}),
							n
						},
						write : function (e) {
			...
			!function (e) {
				...
				e(function () {
					...
					function t(e) {
						...
						n = new FormData;
						for (var r in e)
							e.hasOwnProperty(r) && (t = e[r], t instanceof File ? n.append(r, t, t.name) : t instanceof Blob ? n.append(r, t) : n.append(r, String(t)));
						return n
					}
					return {
						write : function (n) {
			...
			!function (e) {
				...
				e(function () {
					...
					return e.prototype.enqueue = function (e) {
						this._queue[this._queueLen++] = e,
						this.run()
					},
					e.prototype.afterQueue = function (e) {
						this._afterQueue[this._afterQueueLen++] = e,
						this.run()
					},
					...
					e.prototype._drain = function () {
						...
						for (this._queueLen = 0, this._running = !1, e = 0; e < this._afterQueueLen; ++e)
			...
			!function (e) {
				...
				e(function () {
					function e(e, n) {
						...
						function i(t, r) {
							if (t.i < 0)
								return n(t.f, t.thisArg, t.params, r);
				...
				e(function (e) {
					...
					return function (e) {
						function r(t) {
							...
							for (var i, o, u = e._defer(), s = u._handler, c = t.length >>> 0, a = c, f = [], l = 0; c > l; ++l)
								if (o = t[l], void 0 !== o || l in t) {
									if (i = e._handler(o), i.state() > 0) {
										s.become(i),
										e._visitRemaining(t, l, i);
										break
									}
									i.visit(s, n, r)
								} else --a;
							return 0 === a && s.reject(new RangeError("any(): array must not be empty")),
							u
						}
						function i(t, n) {
							function r(e) {
								this.resolved || (f.push(e), 0 === --d && (l = null, this.resolve(f)))
							}
							function i(e) {
								this.resolved || (l.push(e), 0 === --o && (f = null, this.reject(l)))
							}
							var o,
							u,
							s,
							...
							d = 0;
							for (s = 0; p > s; ++s)
								u = t[s], (void 0 !== u || s in t) && ++d;
							for (n = Math.max(n, 0), o = d - n + 1, d = Math.min(n, d), n > d ? a.reject(new RangeError("some(): array must contain at least " + n + " item(s), but had " + d)) : 0 === d && a.resolve(f), s = 0; p > s; ++s)
								u = t[s], (void 0 !== u || s in t) && e._handler(u).visit(a, r, i, a.notify);
							return c
						}
						function o(t, n) {
						...
						function s(t, n) {
							for (var r = n.length, i = new Array(r), o = 0, u = 0; r > o; ++o)
								n[o] && (i[u++] = e._handler(t[o]).value);
							return i.length = u,
							i
						}
						function c(e) {
						...
						function f(e, t) {
							return arguments.length > 2 ? y.call(e, p(t), arguments[2]) : y.call(e, p(t))
						}
						function l(e, t) {
							return arguments.length > 2 ? v.call(e, p(t), arguments[2]) : v.call(e, p(t))
						}
						function p(e) {
				...
				e(function () {
					return function (e) {
						return e.prototype.fold = function (t, n) {
							...
							}, n, r._handler.receiver, r._handler),
							r
						},
						e
					}
				...
				e(function (e) {
					...
					return function (e) {
						...
						return e.prototype.delay = function (e) {
							var t = this._beget();
							return this._handler.fold(i, e, void 0, t._handler),
							t
						},
						e.prototype.timeout = function (e, r) {
							var i = this._beget(),
							o = i._handler,
							s = t(u, e, r, i._handler);
			...
			!function (e) {
				...
				e(function (e) {
					...
					return function (e) {
						...
						function u(e) {
							var t = d.indexOf(e);
							t >= 0 && (d.splice(t, 1), l("Handled previous rejection [" + e.id + "] " + i.formatObject(e.value)))
						}
						function s(e, t) {
							p.push(e, t),
							null === h && (h = r(c, 0))
						...
						"undefined" != typeof console && (a = console, f = "undefined" != typeof a.error ? function (e) {
							a.error(e)
							 ...
							 : function (e) {
							a.log(e)
						}, l = "undefined" != typeof a.info ? function (e) {
							a.info(e)
						}
							 : function (e) {
							a.log(e)
			...
			(function (n) {
				!function (e) {
					...
					e(function (e) {
						...
						var o,
						u = "undefined" != typeof setTimeout && setTimeout,
						s = function (e, t) {
	...
	49 : [function (e, t, n) {
			!function (e) {
				...
				e(function () {
					...
					function t(e) {
						var t = String(e);
						return "[object Object]" === t && "undefined" != typeof JSON && (t = n(e, t)),
						t
					}
					function n(e, t) {
						try {
				...
				!function (t) {
					...
					t(function () {
						return function (t) {
							...
							function s() {
								return new n(b, new _)
							}
							function c(e, t) {
								var n = new _(e.receiver, e.join().context);
								return new t(b, n)
							}
							function a(e) {
								return l(G, null, e)
							...
							function l(e, t, r) {
								function i(n, i, u) {
									u.resolved || p(r, o, n, e(t, i, n), u)
								}
								function o(e, t, n) {
									f[e] = t,
									0 === --a && n.become(new T(f))
								}
								for (var u, s = "function" == typeof t ? i : o, c = new _, a = r.length >>> 0, f = new Array(a), l = 0; l < r.length && !c.resolved; ++l)
									u = r[l], void 0 !== u || l in r ? p(r, s, l, u, c) : --a;
								return 0 === a && c.become(new T(f)),
								new n(b, c)
							}
							function p(e, t, n, r, i) {
								if (I(r)) {
									var o = g(r),
									u = o.state();
									0 === u ? o.fold(t, n, void 0, i) : u > 0 ? t(n, o.value, i) : (i.become(o), d(e, n + 1, o))
								} else
									t(n, r, i)
							}
							function d(e, t, n) {
							...
							function m(e) {
								return "object" != typeof e || null === e ? o(new TypeError("non-iterable passed to race()")) : 0 === e.length ? u() : 1 === e.length ? i(e[0]) : y(e)
							}
							function y(e) {
								var t,
								r,
							...
							n.prototype.then = function (e, t, n) {
								var r = this._handler,
								i = r.join().state();
								if ("function" != typeof e && i > 0 || "function" != typeof t && 0 > i)
									return new this.constructor(b, r);
								var o = this._beget(),
								u = o._handler;
								return r.chain(u, r.receiver, e, t, n),
								o
							},
							...
							n._traverse = f,
							n._visitRemaining = d,
							b.prototype.when = b.prototype.become = b.prototype.notify = b.prototype.fail = b.prototype._unreport = b.prototype._report = J,
							...
							T.prototype.fold = function (e, t, n, r) {
								z(e, t, this, n, r)
							},
							...
							O.prototype.fold = function (e, t, n, r) {
								r.become(this)
							},
							O.prototype.when = function (e) {
								"function" == typeof e.rejected && this._unreport(),
								U(e.rejected, this, e.receiver, e.resolver)
							},
							...
							C.prototype.run = function () {
								...
								if (void 0 !== e)
									for (var t, n = 0; n < e.length; ++n)
										t = e[n], N(t.progress, this.value, this.handler, t.receiver, t.resolver)
							},
	...
	52 : [function (e, t, n) {
			!function (e) {
				...
				e(function (e) {
					...
					function r(e) {
						return function () {
							for (var t = 0, n = arguments.length, r = new Array(n); n > t; ++t)
								r[t] = arguments[t];
							return j(e, this, r)
						}
					}
					function i(e) {
						for (var t = 0, n = arguments.length - 1, r = new Array(n); n > t; ++t)
							r[t] = arguments[t + 1];
						return j(e, this, r)
					}
					function o() {
					...
					_ = e("./lib/TimeoutError"),
					E = [h, m, y, g, w, v, b, d, x].reduce(function (e, t) {
						return t(e)
					}, e("./lib/Promise")),
					j = e("./lib/apply")(E);
					return t.promise = n,
			...
			!function (e) {
				...
				e(function (e) {
					function t(e) {
						...
						u = o.then,
						o.then = function () {
							return r || (r = !0, n.attempt(e).then(i.resolve, i.reject)),
							u.apply(o, arguments)
						},
						o
					}
				...
				e(function () {
					function e(e) {
						...
						for (e || (e = {}), n = 1, r = arguments.length; r > n; n += 1) {
							i = arguments[n];
							for (o in i)
								o in e && (e[o] === i[o] || o in t && t[o] === i[o]) || (e[o] = i[o])
						}
						return e
					}
					var t = {};
	...
	57 : [function (e, t, n) {
			!function (e) {
				...
				e(function (e) {
					...
					function u(e) {
						return e = [].concat(e),
						s(a.reduce(e, function (e, t) {
								if ("string" == typeof t && (t = {
											rel : t
										}), "function" != typeof e.entity.clientFor)
			...
			!function (e) {
				...
				e(function () {
					...
					return r = function () {
						...
						e.unreserved = e.alpha + e.digit + "-._~",
						e.url = e.reserved + e.unreserved,
						e.scheme = e.alpha + e.digit + "+-.",
						e.userinfo = e.unreserved + e.subDelims + ":",
						e.host = e.unreserved + e.subDelims,
						e.port = e.digit,
						e.pchar = e.unreserved + e.subDelims + ":@",
						e.segment = e.pchar,
						e.path = e.segment + "/",
						e.query = e.pchar + "/?",
						e.fragment = e.pchar + "/?",
				...
				e(function (e) {
					function n(e, n, r) {
						return n.split(",").reduce(function (n, i) {
							var u,
							c;
							if (u = {}, "*" === i.slice(-1) && (i = i.slice(0, -1), u.explode = !0), s.test(i)) {
								var a = s.exec(i);
								i = a[1],
								u.maxLength = parseInt(a[2])
							}
							return i = o.decode(i),
							c = r[i],
							c === t || null === c ? n : (Array.isArray(c) ? n += c.reduce(function (t, n) {
									return t.length ? (t += u.explode ? e.separator : ",", e.named && u.explode && (t += e.encoder(i), t += n.length ? "=" : e.empty)) : (t += e.first, e.named && (t += e.encoder(i), t += n.length ? "=" : e.empty)),
									t += e.encoder(n)
								}, "") : "object" == typeof c ? n += Object.keys(c).reduce(function (t, n) {
									return t.length ? t += u.explode ? e.separator : "," : (t += e.first, e.named && !u.explode && (t += e.encoder(i), t += c[n].length ? "=" : e.empty)),
									t += e.encoder(n),
									t += u.explode ? "=" : ",",
									t += e.encoder(c[n])
								}, "") : (c = String(c), u.maxLength && (c = c.slice(0, u.maxLength)), n += n.length ? e.separator : e.first, e.named && (n += e.encoder(i), n += c.length ? "=" : e.empty), n += e.encoder(c)), n)
						}, "")
					}
					function r(e, t) {
						var r;
						if (r = u[e.slice(0, 1)], r ? e = e.slice(1) : r = u[""], r.reserved)
	...
	61 : [function (e, t, n) {
			!function () {
				var e = this,
				r = {};
				"undefined" != typeof n ? t.exports = r : e.fuzzy = r,
				...
				r.match = function (e, t, n) {
					...
					a = n.pre || "",
					f = n.post || "",
					l = n.caseSensitive && t || t.toLowerCase();
					e = n.caseSensitive && e || e.toLowerCase();
					for (var p = 0; u > p; p++)
						r = t[p], l[p] === e[i] ? (r = a + r + f, i += 1, c += 1 + c) : c = 0, s += c, o[o.length] = r;
					return i === e.length ? {
						rendered : o.join(""),
						score : s
					}
	...
	63 : [function (e, t, n) {
			...
			var r = function (e) {
				...
				e.el.parentNode.insertBefore(this.element, e.el.nextSibling),
				this
			};
	...
	64 : [function (e, t, n) {
			...
			u.prototype.getCandidates = function (e) {
				var t = {
					pre : "<strong>",
					post : "</strong>",
					extract : function (e) {
			...
			u.prototype.getItemValue = function (e) {
				return e
			},
			t.exports = u
		}, {
	...
	65 : [function (e, t, n) {
			...
			s = e("mapbox/lib/services/geocoder"),
			c = r(s),
			a = e("suggestions"),
			f = r(a),
			l = e("lodash.debounce"),
			...
			h = function (e) {
				function t(n) {
					...
					this._ev = new d.EventEmitter,
					this.options = u({}, this.options, n)
				}
				return o(t, e),
				t.prototype.onAdd = function (e) {
					...
					i.addEventListener("keypress", p["default"](function (e) {
							t._queryFromInput(e.target.value)
						}), 100),
					i.addEventListener("change", function () {
						...
						if (n) {
							if (n.bbox) {
								var r = n.bbox;
								e.fitBounds([[r[0], r[1]], [r[2], r[3]]])
							} else
								e.flyTo({
									center : n.center
								});
							t._input = n,
							t.fire("geocoder.input", {
								result : n
							})
						}
					});
					...
					var u = this._clearEl = document.createElement("button");
					u.classList.add("geocoder-icon", "geocoder-icon-close"),
					u.addEventListener("click", this._clear.bind(this));
					var s = this._loadingEl = document.createElement("span");
					return s.classList.add("geocoder-icon", "geocoder-icon-loading"),
					o.appendChild(u),
					o.appendChild(s),
					n.appendChild(r),
					n.appendChild(i),
					...
					this.client = new c["default"](this.options.accessToken ? this.options.accessToken : mapboxgl.accessToken),
					this.options.container && (this.options.position = !1),
					this._typeahead = new f["default"](i, []),
					this._typeahead.getItemValue = function (e) {
						return e.place_name
					},
					n
				},
				t.prototype._geocode = function (e, t) {
					var n = this;
					this._loadingEl.classList.toggle("active", !0),
					this.fire("geocoder.loading");
					var r = this.options.proximity ? {
						proximity : {
					 ...
					 : {};
					return this.client.geocodeForward(e.trim(), r, function (e, r) {
						return n._loadingEl.classList.toggle("active", !1),
						e ? n.fire("geocoder.error", {
							error : e.message
					...
					if (e) {
						...
						this._geocode(n, function (e) {
							if (e.length) {
								var n = e[0];
								t._results = e,
								t._typeahead.selected = n;
								var r = document.createEvent("HTMLEvents");
								r.initEvent("change", !0, !1),
								t._inputEl.value = n.place_name,
								t._inputEl.dispatchEvent(r)
							}
						})
					}
				},
